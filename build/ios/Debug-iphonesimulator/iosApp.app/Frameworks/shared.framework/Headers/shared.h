...
@class SharedPhotoDao, SharedHomeDaoCompanion, SharedHomeDao, SharedMetaDataDAO, SharedLocationDAOCompanion, SharedLocationDAO, SharedMetaDataDAOCompanion, SharedPhotoDaoCompanion, SharedLocation, SharedHome, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpClient, SharedKtorApi, SharedSearchQueryState, SharedHomeListResponse, SharedSuggestionsResponse, SharedMapBoundsCompanion, SharedMapBounds, SharedSearchQueryStateCompanion, SharedWantsCompanion, SharedWants, SharedSearchResults, SharedHomeListResponseCompanion, SharedListResultsCompanion, SharedListResults, SharedSearchResultsCompanion, SharedSuggestionsResponseCompanion, SharedZillowApiService, SharedZillowStaticApiService, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedResponse<__covariant T>, SharedKotlinException, SharedResponseError, SharedKotlinNothing, SharedResponseSuccess<T>, SharedKoin_coreKoin, SharedGetHomeListUseCase, SharedGetLocationUseCase, SharedKoin_coreModule, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_client_coreHttpRequestData, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_httpHttpMethod, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKoin_coreKoinDefinition<R>, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreScopeDSL, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpUrl, SharedKtor_httpOutgoingContent, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpURLProtocol, SharedKtor_httpURLBuilderCompanion, SharedKotlinCancellationException, SharedKtor_httpHttpMethodCompanion, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreProxyConfig, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKotlinUnit, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKoin_coreLockable, SharedKoin_coreParametersHolderCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKtor_httpUrlCompanion, SharedKtor_httpContentType, SharedKtor_httpHttpStatusCode, SharedKtor_httpURLProtocolCompanion, SharedKotlinKTypeProjection, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKtor_client_coreHttpClientCallCompanion, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_httpHttpStatusCodeCompanion, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKotlinByteArray, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol SharedPlatform, SharedKotlinx_serialization_coreKSerializer, SharedHomeListRepository, SharedHomeListDataSource, SharedLocationRepository, SharedLocationDataSource, SharedDispatcher, SharedKoin_coreKoinComponent, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedKotlinx_coroutines_coreJob, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreCoroutineScope, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngine, SharedKotlinCoroutineContextKey, SharedKotlinCoroutineContextElement, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinIterator, SharedKtor_utilsStringValues, SharedKotlinMapEntry, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpHeaders, SharedKtor_httpParameters, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_client_coreHttpClientPlugin, SharedKotlinSuspendFunction2, SharedKoin_coreScopeCallback, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKotlinFunction, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_client_coreHttpRequest, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_ioObjectPool;
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeDao")))
@interface SharedHomeDao : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id imgSrc:(NSString * _Nullable)imgSrc carouselPhotos:(NSArray<SharedPhotoDao *> * _Nullable)carouselPhotos price:(NSString * _Nullable)price beds:(SharedInt * _Nullable)beds baths:(SharedDouble * _Nullable)baths statusText:(NSString * _Nullable)statusText address:(NSString * _Nullable)address brokerName:(NSString * _Nullable)brokerName __attribute__((swift_name("init(id:imgSrc:carouselPhotos:price:beds:baths:statusText:address:brokerName:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedHomeDaoCompanion *companion __attribute__((swift_name("companion")));
- (SharedHomeDao *)doCopyId:(NSString * _Nullable)id imgSrc:(NSString * _Nullable)imgSrc carouselPhotos:(NSArray<SharedPhotoDao *> * _Nullable)carouselPhotos price:(NSString * _Nullable)price beds:(SharedInt * _Nullable)beds baths:(SharedDouble * _Nullable)baths statusText:(NSString * _Nullable)statusText address:(NSString * _Nullable)address brokerName:(NSString * _Nullable)brokerName __attribute__((swift_name("doCopy(id:imgSrc:carouselPhotos:price:beds:baths:statusText:address:brokerName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable address __attribute__((swift_name("address")));
@property (readonly) SharedDouble * _Nullable baths __attribute__((swift_name("baths")));
@property (readonly) SharedInt * _Nullable beds __attribute__((swift_name("beds")));
@property (readonly) NSString * _Nullable brokerName __attribute__((swift_name("brokerName")));
@property (readonly) NSArray<SharedPhotoDao *> * _Nullable carouselPhotos __attribute__((swift_name("carouselPhotos")));
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSString * _Nullable imgSrc __attribute__((swift_name("imgSrc")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeDao.Companion")))
@interface SharedHomeDaoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHomeDaoCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocationDAO")))
@interface SharedLocationDAO : SharedBase
- (instancetype)initWithDisplay:(NSString *)display resultType:(NSString *)resultType metaData:(SharedMetaDataDAO *)metaData __attribute__((swift_name("init(display:resultType:metaData:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLocationDAOCompanion *companion __attribute__((swift_name("companion")));
- (SharedLocationDAO *)doCopyDisplay:(NSString *)display resultType:(NSString *)resultType metaData:(SharedMetaDataDAO *)metaData __attribute__((swift_name("doCopy(display:resultType:metaData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *display __attribute__((swift_name("display")));
@property (readonly) SharedMetaDataDAO *metaData __attribute__((swift_name("metaData")));
@property (readonly) NSString *resultType __attribute__((swift_name("resultType")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocationDAO.Companion")))
@interface SharedLocationDAOCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLocationDAOCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MetaDataDAO")))
@interface SharedMetaDataDAO : SharedBase
- (instancetype)initWithRegionId:(int32_t)regionId regionType:(NSString *)regionType city:(NSString * _Nullable)city county:(NSString * _Nullable)county countyFIPS:(NSString * _Nullable)countyFIPS state:(NSString *)state country:(NSString *)country lat:(double)lat lng:(double)lng __attribute__((swift_name("init(regionId:regionType:city:county:countyFIPS:state:country:lat:lng:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMetaDataDAOCompanion *companion __attribute__((swift_name("companion")));
- (SharedMetaDataDAO *)doCopyRegionId:(int32_t)regionId regionType:(NSString *)regionType city:(NSString * _Nullable)city county:(NSString * _Nullable)county countyFIPS:(NSString * _Nullable)countyFIPS state:(NSString *)state country:(NSString *)country lat:(double)lat lng:(double)lng __attribute__((swift_name("doCopy(regionId:regionType:city:county:countyFIPS:state:country:lat:lng:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable county __attribute__((swift_name("county")));
@property (readonly) NSString * _Nullable countyFIPS __attribute__((swift_name("countyFIPS")));
@property (readonly) double lat __attribute__((swift_name("lat")));
@property (readonly) double lng __attribute__((swift_name("lng")));
@property (readonly) int32_t regionId __attribute__((swift_name("regionId")));
@property (readonly) NSString *regionType __attribute__((swift_name("regionType")));
@property (readonly) NSString *state __attribute__((swift_name("state")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MetaDataDAO.Companion")))
@interface SharedMetaDataDAOCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMetaDataDAOCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PhotoDao")))
@interface SharedPhotoDao : SharedBase
- (instancetype)initWithUrl:(NSString *)url __attribute__((swift_name("init(url:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPhotoDaoCompanion *companion __attribute__((swift_name("companion")));
- (SharedPhotoDao *)doCopyUrl:(NSString *)url __attribute__((swift_name("doCopy(url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PhotoDao.Companion")))
@interface SharedPhotoDaoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPhotoDaoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("HomeListRepository")))
@protocol SharedHomeListRepository
@required
...
*/
- (void)getHomeListLocation:(SharedLocation *)location completionHandler:(void (^)(NSArray<SharedHome *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getHomeList(location:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeListRepositoryImpl")))
@interface SharedHomeListRepositoryImpl : SharedBase <SharedHomeListRepository>
- (instancetype)initWithDataSource:(id<SharedHomeListDataSource>)dataSource __attribute__((swift_name("init(dataSource:)"))) __attribute__((objc_designated_initializer));
...
@protocol SharedLocationRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLocationQuery:(NSString *)query completionHandler:(void (^)(NSArray<SharedLocation *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLocation(query:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocationRepositoryImpl")))
@interface SharedLocationRepositoryImpl : SharedBase <SharedLocationRepository>
- (instancetype)initWithDataSource:(id<SharedLocationDataSource>)dataSource __attribute__((swift_name("init(dataSource:)"))) __attribute__((objc_designated_initializer));
...
@interface SharedKtorApi : SharedBase
...
- (void)pathUrl:(SharedKtor_client_coreHttpRequestBuilder *)receiver path:(NSString *)path __attribute__((swift_name("pathUrl(_:path:)")));
@property (readonly) SharedKtor_client_coreHttpClient *client __attribute__((swift_name("client")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ZillowApiService")))
@interface SharedZillowApiService : SharedKtorApi
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getHomesAtLocationQuery:(SharedSearchQueryState *)query completionHandler:(void (^)(SharedHomeListResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getHomesAtLocation(query:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ZillowStaticApiService")))
@interface SharedZillowStaticApiService : SharedKtorApi
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithBaseURL:(NSString *)baseURL __attribute__((swift_name("init(baseURL:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)queryLocationsQuery:(NSString *)query completionHandler:(void (^)(SharedSuggestionsResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("queryLocations(query:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MapBounds")))
@interface SharedMapBounds : SharedBase
- (instancetype)initWithWest:(double)west east:(double)east south:(double)south north:(double)north __attribute__((swift_name("init(west:east:south:north:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMapBoundsCompanion *companion __attribute__((swift_name("companion")));
- (SharedMapBounds *)doCopyWest:(double)west east:(double)east south:(double)south north:(double)north __attribute__((swift_name("doCopy(west:east:south:north:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double east __attribute__((swift_name("east")));
@property (readonly) double north __attribute__((swift_name("north")));
@property (readonly) double south __attribute__((swift_name("south")));
@property (readonly) double west __attribute__((swift_name("west")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MapBounds.Companion")))
@interface SharedMapBoundsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMapBoundsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchQueryState")))
@interface SharedSearchQueryState : SharedBase
- (instancetype)initWithUsersSearchTerm:(NSString *)usersSearchTerm mapBounds:(SharedMapBounds *)mapBounds __attribute__((swift_name("init(usersSearchTerm:mapBounds:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSearchQueryStateCompanion *companion __attribute__((swift_name("companion")));
- (SharedSearchQueryState *)doCopyUsersSearchTerm:(NSString *)usersSearchTerm mapBounds:(SharedMapBounds *)mapBounds __attribute__((swift_name("doCopy(usersSearchTerm:mapBounds:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedMapBounds *mapBounds __attribute__((swift_name("mapBounds")));
@property (readonly) NSString *usersSearchTerm __attribute__((swift_name("usersSearchTerm")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchQueryState.Companion")))
@interface SharedSearchQueryStateCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSearchQueryStateCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Wants")))
@interface SharedWants : SharedBase
- (instancetype)initWithCat1:(NSArray<NSString *> *)cat1 cat2:(NSArray<NSString *> *)cat2 regionResults:(NSArray<NSString *> *)regionResults __attribute__((swift_name("init(cat1:cat2:regionResults:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWantsCompanion *companion __attribute__((swift_name("companion")));
- (SharedWants *)doCopyCat1:(NSArray<NSString *> *)cat1 cat2:(NSArray<NSString *> *)cat2 regionResults:(NSArray<NSString *> *)regionResults __attribute__((swift_name("doCopy(cat1:cat2:regionResults:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<NSString *> *cat1 __attribute__((swift_name("cat1")));
@property (readonly) NSArray<NSString *> *cat2 __attribute__((swift_name("cat2")));
@property (readonly) NSArray<NSString *> *regionResults __attribute__((swift_name("regionResults")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Wants.Companion")))
@interface SharedWantsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWantsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeListResponse")))
@interface SharedHomeListResponse : SharedBase
- (instancetype)initWithCat1:(SharedSearchResults *)cat1 __attribute__((swift_name("init(cat1:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedHomeListResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedHomeListResponse *)doCopyCat1:(SharedSearchResults *)cat1 __attribute__((swift_name("doCopy(cat1:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedSearchResults *cat1 __attribute__((swift_name("cat1")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeListResponse.Companion")))
@interface SharedHomeListResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHomeListResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListResults")))
@interface SharedListResults : SharedBase
- (instancetype)initWithListResults:(NSArray<SharedHomeDao *> *)listResults __attribute__((swift_name("init(listResults:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedListResultsCompanion *companion __attribute__((swift_name("companion")));
- (SharedListResults *)doCopyListResults:(NSArray<SharedHomeDao *> *)listResults __attribute__((swift_name("doCopy(listResults:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedHomeDao *> *listResults __attribute__((swift_name("listResults")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListResults.Companion")))
@interface SharedListResultsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedListResultsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchResults")))
@interface SharedSearchResults : SharedBase
- (instancetype)initWithSearchResults:(SharedListResults *)searchResults __attribute__((swift_name("init(searchResults:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSearchResultsCompanion *companion __attribute__((swift_name("companion")));
- (SharedSearchResults *)doCopySearchResults:(SharedListResults *)searchResults __attribute__((swift_name("doCopy(searchResults:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedListResults *searchResults __attribute__((swift_name("searchResults")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchResults.Companion")))
@interface SharedSearchResultsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSearchResultsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SuggestionsResponse")))
@interface SharedSuggestionsResponse : SharedBase
- (instancetype)initWithResults:(NSMutableArray<SharedLocationDAO *> *)results __attribute__((swift_name("init(results:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSuggestionsResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedSuggestionsResponse *)doCopyResults:(NSMutableArray<SharedLocationDAO *> *)results __attribute__((swift_name("doCopy(results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSMutableArray<SharedLocationDAO *> *results __attribute__((swift_name("results")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SuggestionsResponse.Companion")))
@interface SharedSuggestionsResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSuggestionsResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("HomeListDataSource")))
@protocol SharedHomeListDataSource
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteHomeListDataSourceImpl")))
@interface SharedRemoteHomeListDataSourceImpl : SharedBase <SharedHomeListDataSource>
- (instancetype)initWithService:(SharedZillowApiService *)service dispatcher:(id<SharedDispatcher>)dispatcher __attribute__((swift_name("init(service:dispatcher:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteLocationDataSourceImpl")))
@interface SharedRemoteLocationDataSourceImpl : SharedBase <SharedLocationDataSource>
- (instancetype)initWithApiService:(SharedZillowStaticApiService *)apiService dispatcher:(id<SharedDispatcher>)dispatcher __attribute__((swift_name("init(apiService:dispatcher:)"))) __attribute__((objc_designated_initializer));
...
@interface SharedHome : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id imgSrc:(NSString * _Nullable)imgSrc carouselPhotos:(NSArray<NSString *> * _Nullable)carouselPhotos price:(NSString * _Nullable)price beds:(SharedInt * _Nullable)beds baths:(SharedDouble * _Nullable)baths statusText:(NSString * _Nullable)statusText address:(NSString * _Nullable)address brokerName:(NSString * _Nullable)brokerName __attribute__((swift_name("init(id:imgSrc:carouselPhotos:price:beds:baths:statusText:address:brokerName:)"))) __attribute__((objc_designated_initializer));
- (SharedHome *)doCopyId:(NSString * _Nullable)id imgSrc:(NSString * _Nullable)imgSrc carouselPhotos:(NSArray<NSString *> * _Nullable)carouselPhotos price:(NSString * _Nullable)price beds:(SharedInt * _Nullable)beds baths:(SharedDouble * _Nullable)baths statusText:(NSString * _Nullable)statusText address:(NSString * _Nullable)address brokerName:(NSString * _Nullable)brokerName __attribute__((swift_name("doCopy(id:imgSrc:carouselPhotos:price:beds:baths:statusText:address:brokerName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable address __attribute__((swift_name("address")));
...
@property (readonly) SharedInt * _Nullable beds __attribute__((swift_name("beds")));
@property (readonly) NSString * _Nullable brokerName __attribute__((swift_name("brokerName")));
@property (readonly) NSArray<NSString *> * _Nullable carouselPhotos __attribute__((swift_name("carouselPhotos")));
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSString * _Nullable imgSrc __attribute__((swift_name("imgSrc")));
@property (readonly) NSString * _Nullable price __attribute__((swift_name("price")));
@property (readonly) NSString * _Nullable statusText __attribute__((swift_name("statusText")));
...
- (instancetype)initWithRegionId:(int32_t)regionId name:(NSString *)name type:(NSString *)type regionType:(NSString *)regionType city:(NSString * _Nullable)city countyFIPS:(NSString * _Nullable)countyFIPS county:(NSString * _Nullable)county state:(NSString *)state country:(NSString *)country lat:(double)lat lng:(double)lng __attribute__((swift_name("init(regionId:name:type:regionType:city:countyFIPS:county:state:country:lat:lng:)"))) __attribute__((objc_designated_initializer));
- (SharedLocation *)doCopyRegionId:(int32_t)regionId name:(NSString *)name type:(NSString *)type regionType:(NSString *)regionType city:(NSString * _Nullable)city countyFIPS:(NSString * _Nullable)countyFIPS county:(NSString * _Nullable)county state:(NSString *)state country:(NSString *)country lat:(double)lat lng:(double)lng __attribute__((swift_name("doCopy(regionId:name:type:regionType:city:countyFIPS:county:state:country:lat:lng:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable city __attribute__((swift_name("city")));
...
@interface SharedResponse<__covariant T> : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResponseError")))
@interface SharedResponseError : SharedResponse<SharedKotlinNothing *>
...
- (SharedResponseError *)doCopyError:(SharedKotlinException *)error __attribute__((swift_name("doCopy(error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedResponseSuccess<T> : SharedResponse<T>
- (instancetype)initWithData:(T _Nullable)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
- (SharedResponseSuccess<T> *)doCopyData:(T _Nullable)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetHomeListUseCase")))
@interface SharedGetHomeListUseCase : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeLocation:(SharedLocation *)location completionHandler:(void (^)(NSArray<SharedHome *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(location:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetLocationUseCase")))
@interface SharedGetLocationUseCase : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeQuery:(NSString *)query completionHandler:(void (^)(NSArray<SharedLocation *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(query:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomeListInteractor")))
@interface SharedHomeListInteractor : SharedBase
- (instancetype)initWithGetHomeListUseCase:(SharedGetHomeListUseCase *)getHomeListUseCase __attribute__((swift_name("init(getHomeListUseCase:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getHomeListLocation:(SharedLocation *)location completionHandler:(void (^)(SharedResponse<NSArray<SharedHome *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getHomeList(location:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchInteractor")))
@interface SharedSearchInteractor : SharedBase
- (instancetype)initWithGetLocationUseCase:(SharedGetLocationUseCase *)getLocationUseCase __attribute__((swift_name("init(getLocationUseCase:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLocationQuery:(NSString *)query completionHandler:(void (^)(SharedResponse<NSArray<SharedLocation *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLocation(query:completionHandler:)")));
@end

@interface SharedHomeDao (Extensions)
- (SharedHome *)mapToHome __attribute__((swift_name("mapToHome()")));
@end

@interface SharedLocationDAO (Extensions)
- (SharedLocation *)mapToLocation __attribute__((swift_name("mapToLocation()")));
@end

@interface SharedPhotoDao (Extensions)
- (NSString *)mapToPhoto __attribute__((swift_name("mapToPhoto()")));
@end

@interface SharedLocation (Extensions)
- (SharedSearchQueryState *)mapToSearchQueryState __attribute__((swift_name("mapToSearchQueryState()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MapperKt")))
@interface SharedMapperKt : SharedBase
+ (NSArray<SharedHome *> *)mapToHome:(NSArray<SharedHomeDao *> *)receiver __attribute__((swift_name("mapToHome(_:)")));
+ (NSArray<SharedLocation *> *)mapToLocation:(NSArray<SharedLocationDAO *> *)receiver __attribute__((swift_name("mapToLocation(_:)")));
+ (NSArray<NSString *> *)mapToPhoto:(NSArray<SharedPhotoDao *> *)receiver __attribute__((swift_name("mapToPhoto(_:)")));
@end
...
@interface SharedDispatcherKt : SharedBase
+ (id<SharedDispatcher>)providesDispatcher __attribute__((swift_name("providesDispatcher()")));
@end
